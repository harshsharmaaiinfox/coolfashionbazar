...
var content = [
  {
    path: "",
    loadChildren: () => import("./chunk-TT2TXFL7.js").then((m) => m.ThemesModule),
    title: "Kahuafashionclub Premium Mens and Womens Fashion Online"
  },
  {
    path: "privacy-policy",
    loadChildren: () => import("./chunk-A6AA5INX.js").then((m) => m.PrivacyPolicyModule),
    title: "Privacy Policy \u2013 How We Use Your Data | Kahuafashionclub"
  },
  {
    path: "Contact-Us",
    loadChildren: () => import("./chunk-REPG4ERR.js").then((m) => m.ContactUsModule),
    title: "Contact Kahuafashionclub \u2013 We\u2019re Here to Help You 24/7"
  },
  {
    path: "term-condition",
    loadChildren: () => import("./chunk-TB45WTNF.js").then((m) => m.TermConditionModule),
    title: "Terms & Conditions \u2013 Rules of Using Kahuafashionclub"
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-DCFRS6LS.js").then((m) => m.AuthModule),
    canActivateChild: [AuthGuard],
    title: "Login or Register Your Kahuafashionclub Account Securely"
  },
  {
    path: "account",
    loadChildren: () => import("./chunk-QX75L3VF.js").then((m) => m.AccountModule),
    canActivate: [AuthGuard],
    title: "Manage Your Orders & Profile | Kahuafashionclub Account"
  },
  {
    path: "",
    loadChildren: () => import("./chunk-JCRIP7NQ.js").then((m) => m.ShopModule),
    title: "Browse Fashion Clothing Categories \u2013 Shop Online | Kahuafashionclub"
  },
  {
    path: "",
    loadChildren: () => import("./chunk-MWLQ6AUH.js").then((m) => m.BlogModule),
    title: "Kahuafashionclub Blog \u2013 Latest Fashion News, Tips & Trends"
  },
  {
    path: "",
    loadChildren: () => import("./chunk-2WQOYTFL.js").then((m) => m.PagesModule),
...
var LayoutComponent = class _LayoutComponent {
  ...
  setLogo() {
    var headerLogo = "assets/images/web-logo-2.png";
    var footerLogo = "assets/images/web-logo-2.png";
    var footerClass;
    if (this.theme) {
      if (this.theme == "paris") {
        ...
        headerLogo = "assets/images/web-logo-2.png";
        footerLogo = "assets/images/web-logo-2.png";
        footerClass = "footer-section-2 footer-color-3";
...
var AppComponent = class _AppComponent {
  constructor(document2, config, actions, router, store, seoService, translate, cartService) {
    ...
    this.themeOption$.subscribe((theme) => {
      ...
      this.favIcon.href = "assets/images/web-logo-2.png";
    });
